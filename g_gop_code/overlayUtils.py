...
def draw_cube_test(worldOrientation, worldLocation, tri, window, display, aver = [0,0,0]):
    glPushMatrix()
...
def draw_cube_abg(alpha, beta, gama, x_trans, z_trans, radius, tri, window, display, aver):
    glPushMatrix()
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)
